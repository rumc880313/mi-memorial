...
export default function DetalleJuanPablo() {
  ...
  // 1. Cargar comentarios automáticamente
    ...
    async function fetchComentarios() {
      const { data, error } = await supabase
        .from('comentarios')
        .select('*')
        .eq('id_perfil', 3) // 👈 Solo trae los del Papa
  ...
  const fotosGaleria = [
    "/memoriales/Enrique-Ruiz/ER1.jpeg",
    "/memoriales/Enrique-Ruiz/ER2.jpeg",
...
async function fetchVelas() {
  ...
  const encenderVelaVirtual = async () => {
    ...
    const fechaFallecimiento = new Date("2026-01-08"); // Fecha de fallecimiento (Año-Mes-Día)
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-center w-full max-w-lg">
                  <h1 className="text-3xl md:text-4xl font-serif text-gray-900 mb-10 tracking-tight">
                    Enrique Ruiz Rodriguez
                  </h1>

                  <ul className="space-y-5 text-gray-600 font-light text-sm">
                    <li className="flex items-center justify-center gap-3">
                      <Calendar size={16} className="text-gray-400"/> 
                      <span>Nació en Juventino Rosas, Guanajuato, 13 de Marzo de 1953</span>
                    </li>
                    <li className="flex items-center justify-center gap-3">
                      <MapPin size={16} className="text-gray-400"/> 
                      <span>Falleció en Celaya, 8 de Enero del 2026</span>
                    </li>
                    ...
                    <li className="flex items-center justify-center gap-3">
                      ...
                      <span><strong>Cónyuge:</strong> Margarita Saldaña Rivera</span>
                    </li>
                    <li className="flex items-center justify-center gap-3">
                      <Baby size={16} className="text-gray-400"/> 
                      <span><strong>Hijos:</strong> Luis Enrique Ruiz Saldaña</span>
                    </li>
            ...
            <div className="max-w-4xl mx-auto px-6 mt-12 space-y-8">
                  ...
                  <h2 className="text-xl font-serif text-gray-900 mb-10 border-b pb-4 tracking-wider uppercase">Servicios Funerarios</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="space-y-3">
                          ...
                          <p className="text-gray-800 font-medium">Funeraria Vita NOVA Celaya</p>
                          <p className="text-gray-500 text-sm font-light leading-relaxed">
                            Jueves y Viernes 8-9 de Enero — 10:00 AM<br />
                            Av. 12 de Octubre 310
                          </p>
                        </div>
                        ...
                        <div className="space-y-3 md:border-l border-gray-100 md:pl-10">
                          ...
                          <p className="text-gray-800 font-medium">Parroquia de San Antonio, Juventino Rosas</p>
                          <p className="text-gray-500 text-sm font-light leading-relaxed">
                            Sábado 10 de Enero — 13:00 Hrs<br />                            
                          </p>
                        </div>
                        ...
                        <div className="space-y-3 md:border-l border-gray-100 md:pl-10">
                          ...
                          <p className="text-gray-800 font-medium">Panteón nuevo</p>
                          <p className="text-gray-500 text-sm font-light leading-relaxed">
                            Sábado 10 de Enero — 15:00 Hrs<br />
                ...
                <div className="mt-10 border-t border-gray-100 pt-4">
                    ...
                    <div className="w-full h-80 rounded-sm overflow-hidden shadow-inner border border-gray-100 grayscale-[20%] hover:grayscale-0 transition-all duration-700">
                      <iframe 
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3736.318486015689!2d-100.83803098858398!3d20.534145904502576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x842cbac67c8c4425%3A0xa5d3e9cbd98213e8!2sVita%20Nova%2C%20Casa%20Funeraria!5e0!3m2!1ses-419!2smx!4v1781636472076!5m2!1ses-419!2smx" 
                ...
                <div className="bg-white p-5 rounded-sm shadow-sm border border-gray-200 text-center">
                  ...
                  <p className="text-2xl md:text-2xl font-serif italic text-gray-700 leading-relaxed px-4">
                    "Mantengan firme la esperanza, porque el amor de Dios es más fuerte que el tiempo y la distancia."
                  </p>
                ...
                <div className="bg-white p-10 rounded-sm shadow-sm border border-gray-200">
                  ...
                  <p className="text-gray-700 leading-relaxed font-light text-justify">
                    Enrique, licenciado en administración de empresas por el ITC, conocido por el gusto en la política, vivió su infacia en Juventino Rosas, al cabo del término de su carrera se mudó a Celaya donde vivió gran parte de su vida.
                  </p>
                </div>
